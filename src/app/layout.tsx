...
export const metadata: Metadata = {
  title: "Idisuda - Fine Dining Restaurant",
  description: "Experience culinary excellence at Idisuda. Award-winning restaurant offering gourmet cuisine, premium ingredients, and exceptional service.",
  keywords: "fine dining, restaurant, gourmet cuisine, reservations",
  openGraph: {
    title: "Idisuda - Fine Dining Restaurant",
    description: "Experience culinary excellence at Idisuda",
    type: "website",
    siteName: "Idisuda"
  }
};
